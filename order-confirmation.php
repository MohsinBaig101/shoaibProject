...
<html data-wf-page="617941659e270252256d0297" data-wf-site="6128d6673b5738440887baa4">
<head>
  <meta charset="utf-8">
  <title>rema_v5</title>
    ...
    <div class="w-commerce-commercelayoutcontainer w-container">
      <div class="w-commerce-commercelayoutmain">
        ...
        <div class="w-commerce-commercecheckoutorderitemswrapper">
          ...
          <fieldset class="w-commerce-commercecheckoutblockcontent">
            <script type="text/x-wf-template" id="wf-template-613280b9f4424d3465c82318000000000051"></script>
            <div class="w-commerce-commercecheckoutorderitemslist" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-613280b9f4424d3465c82318000000000051"></div>
          </fieldset>
        </div>
      </div>
      <div class="w-commerce-commercelayoutsidebar">
        <div class="w-commerce-commercecheckoutordersummarywrapper">
          ...
          <fieldset class="w-commerce-commercecheckoutblockcontent">
            ...
            <script type="text/x-wf-template" id="wf-template-613280b9f4424d3465c8231800000000006b">%3Cdiv%20class%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
            <div class="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-613280b9f4424d3465c8231800000000006b">
