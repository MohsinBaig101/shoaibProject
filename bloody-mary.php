...
<html data-wf-page="617941659e270251976d028e" data-wf-site="6128d6673b5738440887baa4">
<head>
  <meta charset="utf-8">
  <title>bloody-mary</title>
  <meta content="bloody-mary" property="og:title">
  <meta content="bloody-mary" property="twitter:title">
...
<body>
  ...
  <div class="div-block-3">
    <div class="div-block-2"><img src="images/Bloody-mary-1.jpg" loading="lazy" width="562" sizes="(max-width: 479px) 100vw, (max-width: 1279px) 50vw, 562px" srcset="images/Bloody-mary-1-p-1080.jpeg 1080w, images/Bloody-mary-1-p-1600.jpeg 1600w, images/Bloody-mary-1-p-2000.jpeg 2000w, images/Bloody-mary-1-p-2600.jpeg 2600w, images/Bloody-mary-1-p-3200.jpeg 3200w, images/Bloody-mary-1.jpg 5760w" alt="chisti rosi / Rema-import"></div>
    <div class="div-block-2">
      <h1 class="heading-11 bloddy">Bloody Mary</h1>
      <p class="paragraph-10 bloody"><span class="text-span">Chisti Rosi Bio-Vodka: 50ml​<br>*Tomatensaft Mischung: 180ml​​ </span><br><br>Zuerst die Tomatenmischung in ein mit Eis gefülltes Glas gießen, dann den Vodka, umrühren und fertig ist der Cocktail.​​<br><br><span class="text-span-2">*Tomatensaft Mischung:​​<br>- Tomatensaft: 1 Liter<br>- ​Fleischtomate: 1 Stück<br>- ​Chipotle Tabasco: 20 ml<br>- Worcester-Sauce: 50ml<br>- ​BBQ-Sauce: 60ml​<br>- Abchasische Ajika: 10g​<br>- Zitronensaft: 20ml​<br>- Salz, Pfeffer: nach Geschmack​​</span><br><br>Die Tomate vorher schälen, alle Zutaten in einen Mixer geben und pürieren. Eine Stunde lang stehen lassen, dann ist die Tomatenmischung fertig.</p>
    </div>
  </div>
  <div class="footer-01">
