...
<html data-wf-page="617941659e27026d036d0293" data-wf-site="6128d6673b5738440887baa4">
<head>
  <meta charset="utf-8">
  <title>Ginger-cocktail</title>
  <meta content="Ginger-cocktail" property="og:title">
  <meta content="Ginger-cocktail" property="twitter:title">
...
<body>
  ...
  <div class="div-block-3">
    <div class="div-block-2"><img src="images/Ginger-Cocktail-1.jpg" loading="lazy" width="562" sizes="(max-width: 479px) 100vw, (max-width: 1279px) 50vw, 562px" srcset="images/Ginger-Cocktail-1-p-1080.jpeg 1080w, images/Ginger-Cocktail-1-p-1600.jpeg 1600w, images/Ginger-Cocktail-1-p-2000.jpeg 2000w, images/Ginger-Cocktail-1-p-2600.jpeg 2600w, images/Ginger-Cocktail-1-p-3200.jpeg 3200w, images/Ginger-Cocktail-1.jpg 4898w" alt="chisti rosi / Rema-import"></div>
    <div class="div-block-2">
      <h1 class="heading-11 bloddy">Ginger Cocktail</h1>
      <p class="paragraph-10 bloody _2"><span class="text-span">- Chisti Rosi Bio-Vodka: 40ml​<br>- *Zitronengras Sirup: 30ml<br>- Zitronensaft: 10ml​<br>- Chilischote: 5g​<br>- Ingwer-Limonade (Ginger Beer): 70ml​​ </span><br><br><span class="text-span-2">*Zitronengras Sirup Herstellen:<br>- Zuckersirup: 250ml (1 zu 1)​<br>- Zitronengras Stiel: 1 Stück.</span><br><br>Zitronengras und Zuckersirup in einem Mixer zerkleinern, eine Stunde lang ziehen lassen, abseihen und fertig ist der Sirup.</p>
    </div>
  </div>
  <div class="footer-01">
