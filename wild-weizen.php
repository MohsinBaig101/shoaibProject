...
<html data-wf-page="617af3019f188958d92dda85" data-wf-site="6128d6673b5738440887baa4">
<head>
  <meta charset="utf-8">
  <title>wild-weizen</title>
  <meta content="wild-weizen" property="og:title">
  <meta content="wild-weizen" property="twitter:title">
...
<body>
  ...
  <div class="product-wrapper spelta">
    <div class="photos">
      <div class="product-fotos">
        <div class="foto"></div>
        <div class="foto _2"></div>
        <div class="foto _3"></div>
      </div><img src="images/bottle-3-red-2-1-1.png" loading="lazy" width="567" sizes="(max-width: 479px) 100vw, 54vw" srcset="images/bottle-3-red-2-1-1-p-500.png 500w, images/bottle-3-red-2-1-1-p-800.png 800w, images/bottle-3-red-2-1-1-p-1080.png 1080w, images/bottle-3-red-2-1-1.png 2200w" alt="" class="image-39 roggen gerste spelta">
    </div>
    <div class="descripti-wrapper">
      <h1 class="heading-15">Chisti Rosi Bio Vodka <br>Wild-weizen</h1>
      ...
      <div class="variationn">
        <div class="varition">
          <h3 class="heading-16">ohne box</h3>
        </div>
        <div class="varition _2">
          <h3 class="heading-16 _2">mit box</h3>
        </div>
      </div>
      <h3 class="heading-14 weizen">99,99 € <span class="text-span-3">inkl. Mwst</span></h3>
